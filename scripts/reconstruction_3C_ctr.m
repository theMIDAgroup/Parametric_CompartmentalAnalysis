function [k1x,k2x,k3x,k4x,k5x,k6x,k7x,relerr,nit,Cxdata] = reconstruction_3C_ctr(Cdata,Ca,t)
...
%     disp('running')
    ...
    if  ( relerr>=1 && abs(relerr-relerrprec)<1e-3 ) || ( nit>=15 && relerr>=1 ) || ( nit>=15 && abs(relerr-relerrprec)<1e-2 ) || (nit>=nit_max)
        ...
        if attempt==1
            ...
            attempt = 2;
            nit = 0;
            [k1x,k2x,k3x,k4x,k5x,k6x,k7x] = deal(1,0.1,1,1,1,1e-1,1e-3); % K6=10^2*K7
            x = [k1x;k2x;k3x;k4x;k5x;k6x;k7x];          
